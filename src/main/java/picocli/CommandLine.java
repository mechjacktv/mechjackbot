...
public class CommandLine {
  ...
  public CommandLine(Object command, IFactory factory) {
    ...
    this.commandSpec = CommandSpec.forAnnotatedObject(command, factory);
   ...
   * @since 3.0 */
  public CommandSpec getCommandSpec() { return this.commandSpec; }
  ...
  public CommandLine addMixin(String name, Object mixin) {
    this.getCommandSpec().addMixin(name, CommandSpec.forAnnotatedObject(mixin, this.factory));
    return this;
  }
  ...
  public Map<String, Object> getMixins() {
    Map<String, CommandSpec> mixins = this.getCommandSpec().mixins();
  ...
  public CommandLine addSubcommand(String name, Object command, String... aliases) {
    CommandLine subcommandLine = toCommandLine(command, this.factory);
    subcommandLine.getCommandSpec().aliases.addAll(Arrays.asList(aliases));
    this.getCommandSpec().addSubcommand(name, subcommandLine);
    CommandLine.Model.CommandReflection.initParentCommand(subcommandLine.getCommandSpec().userObject(),
        this.getCommandSpec().userObject());
    return this;
  }
  ...
  public CommandLine getParent() {
    CommandSpec parent = this.getCommandSpec().parent();
   ...
   * @since 0.9.8 */
  public boolean isUsageHelpRequested() { return this.interpreter.parseResult != null && this.interpreter.parseResult.usageHelpRequested; }
   ...
   * @since 0.9.8 */
  public boolean isVersionHelpRequested() { return this.interpreter.parseResult != null && this.interpreter.parseResult.versionHelpRequested; }
   ...
   * @since 3.0 */
  public boolean isPosixClusteredShortOptionsAllowed() { return this.getCommandSpec().parser().posixClusteredShortOptionsAllowed(); }
   ...
   * @since 3.4 */
  public boolean isCaseInsensitiveEnumValuesAllowed() { return this.getCommandSpec().parser().caseInsensitiveEnumValuesAllowed(); }
   ...
   * @since 3.7 */
  public boolean isTrimQuotes() { return this.getCommandSpec().parser().trimQuotes(); }
   ...
   * @since 3.7 */
  public boolean isSplitQuotedStrings() { return this.getCommandSpec().parser().splitQuotedStrings(); }
   ...
   * @since 3.5 */
  public String getEndOfOptionsDelimiter() { return this.getCommandSpec().parser().endOfOptionsDelimiter(); }
  ...
  public List<String> getUnmatchedArguments() {
    return this.interpreter.parseResult == null ? Collections.emptyList() : Collections.unmodifiableList(
        this.interpreter.parseResult.unmatched);
  }
  ...
  public ParseResult getParseResult() { return this.interpreter.parseResult == null ? null : this.interpreter.parseResult.build(); }
  /**
   ...
   * @since 2.0 */
  @Deprecated public interface IExceptionHandler {
  ...
  public static abstract class AbstractHandler<R, T extends AbstractHandler<R, T>> {
    ...
    public PrintStream err()     { return this.err; }
    ...
    public Help.Ansi ansi()      { return this.ansi; }
    ...
    public boolean hasExitCode() { return this.exitCode != null; }
    ...
    protected R returnResultOrExit(R result) {
      if (this.hasExitCode()) { System.exit(this.exitCode()); }
      return result;
    }
     ...
     * @see #out() */
    public T useOut(PrintStream out)   { this.out =  Assert.notNull(out, "out");   return this.self(); }
    /** Sets the stream to print diagnostic messages to. For use by {@code IExceptionHandler2} implementations.
     * @see #err()*/
    public T useErr(PrintStream err)   { this.err =  Assert.notNull(err, "err");   return this.self(); }
    /** Sets the ANSI style to use.
     * @see #ansi() */
    public T useAnsi(Help.Ansi ansi)   { this.ansi = Assert.notNull(ansi, "ansi"); return this.self(); }
    ...
    public T andExit(int exitCode)     { this.exitCode = exitCode; return this.self(); }
  }
  ...
  public static class DefaultExceptionHandler<R> extends AbstractHandler<R, DefaultExceptionHandler<R>> implements IExceptionHandler, IExceptionHandler2<R> {
    public List<Object> handleException(ParameterException ex, PrintStream out, Help.Ansi ansi, String... args) {
      this.internalHandleParseException(ex, out, ansi, args); return Collections.emptyList(); }
    ...
    public R handleParseException(ParameterException ex, String[] args) {
      this.internalHandleParseException(ex, this.err(), this.ansi(), args); return this.returnResultOrExit(null); }
  ...
  public abstract static class AbstractParseResultHandler<R> extends AbstractHandler<R, AbstractParseResultHandler<R>> implements IParseResultHandler2<R> {
    ...
    public R handleParseResult(ParseResult parseResult) throws ExecutionException {
      if (printHelpIfRequested(parseResult.asCommandLineList(), this.out(), this.err(), this.ansi())) {
  ...
  public static class RunFirst extends AbstractParseResultHandler<List<Object>> implements IParseResultHandler {
    ...
    public List<Object> handleParseResult(List<CommandLine> parsedCommands, PrintStream out, Help.Ansi ansi) {
      if (printHelpIfRequested(parsedCommands, out, this.err(), ansi)) { return this.returnResultOrExit(Collections.emptyList()); }
      return this.returnResultOrExit(execute(parsedCommands.get(0), new ArrayList<Object>()));
    }
  ...
  public static class RunLast extends AbstractParseResultHandler<List<Object>> implements IParseResultHandler {
    ...
    public List<Object> handleParseResult(List<CommandLine> parsedCommands, PrintStream out, Help.Ansi ansi) {
      if (printHelpIfRequested(parsedCommands, out, this.err(), ansi)) { return this.returnResultOrExit(Collections.emptyList()); }
      return this.returnResultOrExit(execute(parsedCommands.get(parsedCommands.size() - 1), new ArrayList<Object>()));
    }
  ...
  @Deprecated public List<Object> parseWithHandler(IParseResultHandler handler, PrintStream out, String... args) {
    return this.parseWithHandlers(handler, out, Help.Ansi.AUTO, defaultExceptionHandler(), args);
  }
  /**
  ...
  public <R> R parseWithHandler(IParseResultHandler2<R> handler, String[] args) {
    return this.parseWithHandlers(handler, new DefaultExceptionHandler<R>(), args);
  }
  ...
  public void usage(PrintStream out, Help.ColorScheme colorScheme) {
    out.print(usage(new StringBuilder(), new Help(this.getCommandSpec(), colorScheme)));
  }
  ...
  public void usage(PrintWriter writer, Help.ColorScheme colorScheme) {
    writer.print(usage(new StringBuilder(), new Help(this.getCommandSpec(), colorScheme)));
  }
  ...
  public String getUsageMessage() {
    return usage(new StringBuilder(), new Help(this.getCommandSpec())).toString();
  }
  ...
  public String getUsageMessage(Help.Ansi ansi) {
    return usage(new StringBuilder(), new Help(this.getCommandSpec(), ansi)).toString();
  }
  ...
  public String getUsageMessage(Help.ColorScheme colorScheme) {
    return usage(new StringBuilder(), new Help(this.getCommandSpec(), colorScheme)).toString();
  }
  ...
  public String getSeparator() { return this.getCommandSpec().parser().separator(); }
   ...
   * @since 3.6 */
  public ResourceBundle getResourceBundle() { return this.getCommandSpec().resourceBundle(); }
  ...
  public int getUsageHelpWidth() { return this.getCommandSpec().usageMessage().width(); }
   ...
   * @since 2.0 */
  public String getCommandName() { return this.getCommandSpec().name(); }
   ...
   * @since 2.1 */
  public boolean isExpandAtFiles() { return this.getCommandSpec().parser().expandAtFiles(); }
   ...
   * @since 3.5 */
  public Character getAtFileCommentChar() { return this.getCommandSpec().parser().atFileCommentChar(); }
  ...
  public static class Range implements Comparable<Range> {
    ...
    private int size() { return 1 + this.max - this.min; }
    ...
    public Range min(int newMin) { return new Range(newMin, Math.max(newMin, this.max), this.isVariable, this.isUnspecified,
        this.originalValue); }
    ...
    public Range max(int newMax) { return new Range(Math.min(this.min, newMax), newMax, this.isVariable, this.isUnspecified,
        this.originalValue); }
    ...
    public Range unspecified(boolean unspecified) { return new Range(this.min, this.max, this.isVariable, unspecified,
        this.originalValue); }
     ...
     */
    public boolean contains(int value) { return this.min <= value && this.max >= value; }
    ...
    public int hashCode() {
      return ((17 * 37 + this.max) * 37 + this.min) * 37 + (this.isVariable ? 1 : 0);
    }
  ...
  public static final class Model {
    ...
    public static class CommandSpec {
      ...
      void validate() {
        ...
        validatePositionalParameters(this.positionalParameters);
      ...
      public Object userObject() { return this.userObject; }

      /** Returns the CommandLine constructed with this {@code CommandSpec} model. */
      public CommandLine commandLine() { return this.commandLine;}
      ...
      public ParserSpec parser() { return this.parser; }
      ...
      public CommandSpec parser(ParserSpec settings) {
        this.parser.initFrom(settings); return this; }

      /** Returns the usage help message specification for this command. */
      public UsageMessageSpec usageMessage() { return this.usageMessage; }
      ...
      public CommandSpec usageMessage(UsageMessageSpec settings) {
        this.usageMessage.initFrom(settings, this); return this; }

      /** Returns the resource bundle for this command.
       * @return the resource bundle from the {@linkplain UsageMessageSpec#messages()}
       * @since 3.6 */
      public ResourceBundle resourceBundle() { return Messages.resourceBundle(this.usageMessage.messages()); }
      ...
      private void updateArgSpecMessages() {
        for (OptionSpec opt : this.options()) { opt.messages(this.usageMessage().messages()); }
        for (PositionalParamSpec pos : this.positionalParameters()) { pos.messages(this.usageMessage().messages()); }
      }

      /** Returns a read-only view of the subcommand map. */
      public Map<String, CommandLine> subcommands() { return Collections.unmodifiableMap(this.commands); }
      ...
      public CommandSpec addSubcommand(String name, CommandLine subCommandLine) {
        CommandLine previous = this.commands.put(name, subCommandLine);
        ...
        for (String alias : subSpec.aliases()) {
          previous = this.commands.put(alias, subCommandLine);
      ...
      private void initResourceBundle(ResourceBundle bundle) {
        ...
        for (CommandLine sub : this.commands.values()) { // percolate down the hierarchy
       ...
       * @since 3.6.0
       */
      public CommandSpec addMethodSubcommands() { return this.addMethodSubcommands(new DefaultFactory()); }
      ...
      public CommandSpec addMethodSubcommands(IFactory factory) {
        if (this.userObject() instanceof Method) {
          throw new UnsupportedOperationException("cannot discover methods of non-class: " + this.userObject());
        }
        for (Method method : getCommandMethods(this.userObject().getClass(), null)) {
          CommandLine cmd = new CommandLine(method, factory);
          this.addSubcommand(cmd.getCommandName(), cmd);
        }
        return this;
      }

      /** Returns the parent command of this subcommand, or {@code null} if this is a top-level command. */
      public CommandSpec parent() { return this.parent; }
       ...
       * @return this CommandSpec for method chaining */
      public CommandSpec add(ArgSpec arg) { return arg.isOption() ?
          this.addOption((OptionSpec) arg) : this.addPositional((PositionalParamSpec) arg); }
      ...
      public CommandSpec addOption(OptionSpec option) {
        ...
        for (String name : option.names()) { // cannot be null or empty
          ...
          if (name.length() == 2 && name.startsWith("-")) {
            this.posixOptionsByKeyMap.put(name.charAt(1), option); }
        }
        if (option.required()) {
      ...
      public CommandSpec addUnmatchedArgsBinding(UnmatchedArgsBinding spec) {
        ...
        this.parser().unmatchedArgumentsAllowed(true); return this; }
      ...
      public Map<String, CommandSpec> mixins() { return Collections.unmodifiableMap(this.mixins); }

      /** Returns the list of options configured for this command.
       * @return an immutable list of options that this command recognizes. */
      public List<OptionSpec> options() { return Collections.unmodifiableList(this.options); }
      ...
      public List<PositionalParamSpec> positionalParameters() { return Collections.unmodifiableList(
      ...
      public Map<String, OptionSpec> optionsMap() { return Collections.unmodifiableMap(this.optionsByNameMap); }

      /** Returns a map of the short (single character) option names to option spec objects configured for this command.
       * @return an immutable map of options that this command recognizes. */
      public Map<Character, OptionSpec> posixOptionsMap() { return Collections.unmodifiableMap(
          this.posixOptionsByKeyMap); }
      ...
      public List<ArgSpec> requiredArgs() { return Collections.unmodifiableList(this.requiredArgs); }
      ...
      public List<UnmatchedArgsBinding> unmatchedArgsBindings() { return Collections.unmodifiableList(
          this.unmatchedArgs); }
       ...
       * @see #qualifiedName() */
      public String name() { return (this.name == null) ? DEFAULT_COMMAND_NAME : this.name; }

      /** Returns the alias command names of this subcommand.
       * @since 3.1 */
      public String[] aliases() { return this.aliases.toArray(new String[0]); }
      ...
      public List<ArgSpec> args() { return Collections.unmodifiableList(this.args); }
      Object[] argValues() {
        ...
        for (Map.Entry<String, CommandSpec> mixinEntry : this.mixins.entrySet()) {
          ...
          if (allMixins == null) {
            allMixins = new IdentityHashMap<Class<?>, CommandSpec>(this.mixins.size());
          }
        ...
        if (allMixins == null) {
          for (int i = 0; i < values.length; i++) { values[i] = this.args.get(i + shift).getValue(); }
        } else {
          int argIndex = shift;
      ...
      public String qualifiedName(String separator) {
        ...
        if (this.parent() != null) { result = this.parent().qualifiedName(separator) + separator + result; }
        return result;
      }
      ...
      public IVersionProvider versionProvider() { return this.versionProvider; }
      ...
      public boolean helpCommand() { return (this.isHelpCommand == null) ? DEFAULT_IS_HELP_COMMAND : this.isHelpCommand; }

      /** Returns {@code true} if the standard help options have been mixed in with this command, {@code false} otherwise. */
      public boolean mixinStandardHelpOptions() { return this.mixins.containsKey(AutoHelpMixin.KEY); }
       ...
       * @since 3.6 */
      public IDefaultValueProvider defaultValueProvider() { return this.defaultValueProvider; }
      ...
      public CommandSpec helpCommand(boolean newValue) {
        this.isHelpCommand = newValue; return this;}
      ...
      public CommandSpec mixinStandardHelpOptions(boolean newValue) {
        if (newValue) {
          ...
          this.addMixin(AutoHelpMixin.KEY, mixin);
        } else {
          CommandSpec helpMixin = this.mixins.remove(AutoHelpMixin.KEY);
          if (helpMixin != null) {
            ...
            for (OptionSpec option : helpMixin.options()) {
              for (String name : option.names) {
                ...
                if (name.length() == 2 && name.startsWith("-")) {
                  this.posixOptionsByKeyMap.remove(name.charAt(1)); }
              }
            }
          }
        }
      ...
      void initName(String value)                 { if (initializable(this.name, value, DEFAULT_COMMAND_NAME))                           {
        this.name = value;} }
      void initHelpCommand(boolean value)         { if (initializable(this.isHelpCommand, value, DEFAULT_IS_HELP_COMMAND))               {
        this.isHelpCommand = value;} }
      void initVersion(String[] value)            { if (initializable(this.version, value, UsageMessageSpec.DEFAULT_MULTI_LINE))         {
        this.version = value.clone();} }
      void initVersionProvider(IVersionProvider value) { if (this.versionProvider == null) {
        this.versionProvider = value; } }
      void initVersionProvider(Class<? extends IVersionProvider> value, IFactory factory) {
        if (initializable(this.versionProvider, value, NoVersionProvider.class)) {
          this.versionProvider = (DefaultFactory.createVersionProvider(factory, value)); }
      }
      void initDefaultValueProvider(IDefaultValueProvider value) { if (this.defaultValueProvider == null) {
        this.defaultValueProvider = value; } }
      void initDefaultValueProvider(Class<? extends IDefaultValueProvider> value, IFactory factory) {
        if (initializable(this.defaultValueProvider, value, NoDefaultProvider.class)) {
          this.defaultValueProvider = (DefaultFactory.createDefaultValueProvider(factory, value)); }
      }
      void updateName(String value)               { if (isNonDefault(value, DEFAULT_COMMAND_NAME))                 {
        this.name = value;} }
      void updateHelpCommand(boolean value)       { if (isNonDefault(value, DEFAULT_IS_HELP_COMMAND))              {
        this.isHelpCommand = value;} }
      void updateVersion(String[] value)          { if (isNonDefault(value, UsageMessageSpec.DEFAULT_MULTI_LINE))  {
        this.version = value.clone();} }
      ...
      public OptionSpec findOption(char shortName) { return findOption(shortName, this.options()); }
      ...
      public OptionSpec findOption(String name) { return findOption(name, this.options()); }
      ...
      boolean resemblesOption(String arg, Tracer tracer) {
        ...
        boolean result = count > 0 && count * 10 >= this.optionsMap().size() * 9; // at least one prefix char in common with 9 out of 10 options
        if (tracer != null && tracer.isDebug()) {tracer.debug("%s %s an option: %d matching prefix chars out of %d option names%n", arg, (result ? "resembles" : "doesn't resemble"), count,
            this.optionsMap().size());}
        return result;
      }
    }
    ...
    public static class UsageMessageSpec {
      ...
      public int width() { return getSysPropertyWidthOrDefault(this.width); }
      ...
      public UsageMessageSpec width(int newValue) {
        ...
        this.width = newValue; return this;
      }
      ...
      private String   resourceStr(String key) { return this.messages == null ? null : this.messages.getString(key, null); }
      private String[] resourceArr(String key) { return this.messages == null ? null : this.messages.getStringArray(key, null); }

      /** Returns the optional heading preceding the header section. Initialized from {@link Command#headerHeading()}, or null. */
      public String headerHeading() { return this
          .str(this.resourceStr("usage.headerHeading"), this.headerHeading, DEFAULT_SINGLE_VALUE); }
      ...
      public String[] header() { return this.arr(this.resourceArr("usage.header"), this.header, DEFAULT_MULTI_LINE); }

      /** Returns the optional heading preceding the synopsis. Initialized from {@link Command#synopsisHeading()}, {@code "Usage: "} by default. */
      public String synopsisHeading() { return this
          .str(this.resourceStr("usage.synopsisHeading"), this.synopsisHeading, DEFAULT_SYNOPSIS_HEADING); }

      /** Returns whether the synopsis line(s) should show an abbreviated synopsis without detailed option names. */
      public boolean abbreviateSynopsis() { return (this.abbreviateSynopsis == null) ? DEFAULT_ABBREVIATE_SYNOPSIS :
          this.abbreviateSynopsis; }
      ...
      public String[] customSynopsis() { return this
          .arr(this.resourceArr("usage.customSynopsis"), this.customSynopsis, DEFAULT_MULTI_LINE); }

      /** Returns the optional heading preceding the description section. Initialized from {@link Command#descriptionHeading()}, or null. */
      public String descriptionHeading() { return this
          .str(this.resourceStr("usage.descriptionHeading"), this.descriptionHeading, DEFAULT_SINGLE_VALUE); }
       ...
       * Applications may programmatically set this field to create a custom help message. */
      public String[] description() { return this
          .arr(this.resourceArr("usage.description"), this.description, DEFAULT_MULTI_LINE); }

      /** Returns the optional heading preceding the parameter list. Initialized from {@link Command#parameterListHeading()}, or null. */
      public String parameterListHeading() { return this.str(this.resourceStr("usage.parameterListHeading"),
          this.parameterListHeading, DEFAULT_SINGLE_VALUE); }

      /** Returns the optional heading preceding the options list. Initialized from {@link Command#optionListHeading()}, or null. */
      public String optionListHeading() { return this
          .str(this.resourceStr("usage.optionListHeading"), this.optionListHeading, DEFAULT_SINGLE_VALUE); }

      /** Returns whether the options list in the usage help message should be sorted alphabetically. */
      public boolean sortOptions() { return (this.sortOptions == null) ? DEFAULT_SORT_OPTIONS : this.sortOptions; }

      /** Returns the character used to prefix required options in the options list. */
      public char requiredOptionMarker() { return (this.requiredOptionMarker == null) ? DEFAULT_REQUIRED_OPTION_MARKER :
          this.requiredOptionMarker; }

      /** Returns whether the options list in the usage help message should show default values for all non-boolean options. */
      public boolean showDefaultValues() { return (this.showDefaultValues == null) ? DEFAULT_SHOW_DEFAULT_VALUES :
       ...
       */
      public boolean hidden() { return (this.hidden == null) ? DEFAULT_HIDDEN : this.hidden; }
      ...
      public String commandListHeading() { return this
          .str(this.resourceStr("usage.commandListHeading"), this.commandListHeading, DEFAULT_COMMAND_LIST_HEADING); }

      /** Returns the optional heading preceding the footer section. Initialized from {@link Command#footerHeading()}, or null. */
      public String footerHeading() { return this
          .str(this.resourceStr("usage.footerHeading"), this.footerHeading, DEFAULT_SINGLE_VALUE); }
       ...
       * Applications may programmatically set this field to create a custom help message. */
      public String[] footer() { return this.arr(this.resourceArr("usage.footer"), this.footer, DEFAULT_MULTI_LINE); }
      ...
      public UsageMessageSpec synopsisHeading(String newValue) {
        this.synopsisHeading = newValue; return this;}
      ...
      public UsageMessageSpec abbreviateSynopsis(boolean newValue) {
        this.abbreviateSynopsis = newValue; return this;}
      ...
      public UsageMessageSpec descriptionHeading(String newValue) {
        this.descriptionHeading = newValue; return this;}
      ...
      public UsageMessageSpec sortOptions(boolean newValue) {
        this.sortOptions = newValue; return this;}
      ...
      public UsageMessageSpec requiredOptionMarker(char newValue) {
        this.requiredOptionMarker = newValue; return this;}
      ...
      public UsageMessageSpec showDefaultValues(boolean newValue) {
        this.showDefaultValues = newValue; return this;}
      ...
      public UsageMessageSpec messages(Messages msgs) {
        this.messages = msgs; return this; }
      void updateFromCommand(Command cmd, CommandSpec commandSpec) {
        ...
        if (isNonDefault(cmd.requiredOptionMarker(), DEFAULT_REQUIRED_OPTION_MARKER)) {
          this.requiredOptionMarker = cmd.requiredOptionMarker();}
        ...
        if (isNonDefault(cmd.customSynopsis(), DEFAULT_MULTI_LINE))                   {
          this.customSynopsis = cmd.customSynopsis().clone();}
        if (isNonDefault(cmd.description(), DEFAULT_MULTI_LINE))                      {
          this.description = cmd.description().clone();}
        ...
        if (isNonDefault(cmd.usageHelpWidth(), DEFAULT_USAGE_WIDTH))                  {
          this.width(cmd.usageHelpWidth());} // validate

        ResourceBundle rb = empty(cmd.resourceBundle()) ? null : ResourceBundle.getBundle(cmd.resourceBundle());
        if (rb != null) {
          this.messages(new Messages(commandSpec, rb)); } // else preserve superclass bundle
      }
      void initFromMixin(UsageMessageSpec mixin, CommandSpec commandSpec) {
        if (initializable(this.synopsisHeading, mixin.synopsisHeading(), DEFAULT_SYNOPSIS_HEADING))                 {
          this.synopsisHeading = mixin.synopsisHeading();}
        if (initializable(this.commandListHeading, mixin.commandListHeading(), DEFAULT_COMMAND_LIST_HEADING))       {
          this.commandListHeading = mixin.commandListHeading();}
        if (initializable(this.requiredOptionMarker, mixin.requiredOptionMarker(), DEFAULT_REQUIRED_OPTION_MARKER)) {
          this.requiredOptionMarker = mixin.requiredOptionMarker();}
        if (initializable(this.abbreviateSynopsis, mixin.abbreviateSynopsis(), DEFAULT_ABBREVIATE_SYNOPSIS))        {
          this.abbreviateSynopsis = mixin.abbreviateSynopsis();}
        if (initializable(this.sortOptions, mixin.sortOptions(), DEFAULT_SORT_OPTIONS))                             {
          this.sortOptions = mixin.sortOptions();}
        if (initializable(this.showDefaultValues, mixin.showDefaultValues(), DEFAULT_SHOW_DEFAULT_VALUES))          {
          this.showDefaultValues = mixin.showDefaultValues();}
        if (initializable(this.hidden, mixin.hidden(), DEFAULT_HIDDEN))                                             {
          this.hidden = mixin.hidden();}
        if (initializable(this.customSynopsis, mixin.customSynopsis(), DEFAULT_MULTI_LINE))                         {
          this.customSynopsis = mixin.customSynopsis().clone();}
        if (initializable(this.description, mixin.description(), DEFAULT_MULTI_LINE))                               {
          this.description = mixin.description().clone();}
        if (initializable(this.descriptionHeading, mixin.descriptionHeading(), DEFAULT_SINGLE_VALUE))               {
          this.descriptionHeading = mixin.descriptionHeading();}
        if (initializable(this.header, mixin.header(), DEFAULT_MULTI_LINE))                                         {
          this.header = mixin.header().clone();}
        if (initializable(this.headerHeading, mixin.headerHeading(), DEFAULT_SINGLE_VALUE))                         {
          this.headerHeading = mixin.headerHeading();}
        if (initializable(this.footer, mixin.footer(), DEFAULT_MULTI_LINE))                                         {
          this.footer = mixin.footer().clone();}
        if (initializable(this.footerHeading, mixin.footerHeading(), DEFAULT_SINGLE_VALUE))                         {
          this.footerHeading = mixin.footerHeading();}
        if (initializable(this.parameterListHeading, mixin.parameterListHeading(), DEFAULT_SINGLE_VALUE))           {
          this.parameterListHeading = mixin.parameterListHeading();}
        if (initializable(this.optionListHeading, mixin.optionListHeading(), DEFAULT_SINGLE_VALUE))                 {
    ...
    public static class ParserSpec {
      ...
      public String separator() { return (this.separator == null) ? DEFAULT_SEPARATOR : this.separator; }

      /** @see CommandLine#isStopAtUnmatched() */
      public boolean stopAtUnmatched()                   { return this.stopAtUnmatched; }
      /** @see CommandLine#isStopAtPositional() */
      public boolean stopAtPositional()                  { return this.stopAtPositional; }
      /** @see CommandLine#getEndOfOptionsDelimiter()
       * @since 3.5 */
      public String endOfOptionsDelimiter()             { return this.endOfOptionsDelimiter; }
      /** @see CommandLine#isToggleBooleanFlags() */
      public boolean toggleBooleanFlags()                { return this.toggleBooleanFlags; }
      /** @see CommandLine#isOverwrittenOptionsAllowed() */
      public boolean overwrittenOptionsAllowed()         { return this.overwrittenOptionsAllowed; }
      /** @see CommandLine#isUnmatchedArgumentsAllowed() */
      public boolean unmatchedArgumentsAllowed()         { return this.unmatchedArgumentsAllowed; }
      /** @see CommandLine#isExpandAtFiles() */
      public boolean expandAtFiles()                     { return this.expandAtFiles; }
      /** @see CommandLine#getAtFileCommentChar()
       * @since 3.5 */
      public Character atFileCommentChar()               { return this.atFileCommentChar; }
      /** @see CommandLine#isPosixClusteredShortOptionsAllowed() */
      public boolean posixClusteredShortOptionsAllowed() { return this.posixClusteredShortOptionsAllowed; }
      /** @see CommandLine#isCaseInsensitiveEnumValuesAllowed()
       * @since 3.4 */
      public boolean caseInsensitiveEnumValuesAllowed()  { return this.caseInsensitiveEnumValuesAllowed; }
      /** @see CommandLine#isTrimQuotes()
       * @since 3.7 */
      public boolean trimQuotes()  { return this.trimQuotes; }
      /** @see CommandLine#isSplitQuotedStrings()
       * @since 3.7 */
      public boolean splitQuotedStrings()  { return this.splitQuotedStrings; }
      /** @see CommandLine#isUnmatchedOptionsArePositionalParams() */
      public boolean unmatchedOptionsArePositionalParams() { return this.unmatchedOptionsArePositionalParams; }
      private boolean splitFirst()                       { return this.limitSplit(); }
      ...
      public boolean limitSplit()                        { return this.limitSplit; }
      /** Returns true if options with attached arguments should not consume subsequent arguments and should not validate arity. */
      public boolean aritySatisfiedByAttachedOptionParam() { return this.aritySatisfiedByAttachedOptionParam; }
       ...
       * @since 3.2 */
      public boolean collectErrors()                     { return this.collectErrors; }
      ...
      public ParserSpec aritySatisfiedByAttachedOptionParam(boolean newValue) {
        this.aritySatisfiedByAttachedOptionParam = newValue; return this; }
      ...
      void initSeparator(String value)   { if (initializable(this.separator, value, DEFAULT_SEPARATOR)) {
        this.separator = value;} }
      void updateSeparator(String value) { if (isNonDefault(value, DEFAULT_SEPARATOR))             {
        this.separator = value;} }
      public String toString() {
        return String.format("posixClusteredShortOptionsAllowed=%s, stopAtPositional=%s, stopAtUnmatched=%s, " +
            ...
            this.posixClusteredShortOptionsAllowed, this.stopAtPositional, this.stopAtUnmatched,
            this.separator, this.overwrittenOptionsAllowed, this.unmatchedArgumentsAllowed, this.expandAtFiles,
            this.atFileCommentChar, this.endOfOptionsDelimiter, this.limitSplit, this.aritySatisfiedByAttachedOptionParam,
            this.toggleBooleanFlags, this.unmatchedOptionsArePositionalParams, this.collectErrors,
            this.caseInsensitiveEnumValuesAllowed, this.trimQuotes, this.splitQuotedStrings);
      }
    ...
    public abstract static class ArgSpec {
      ...
      private <T extends Builder<T>> ArgSpec(Builder<T> builder) {
        ...
        this.paramLabel = empty(builder.paramLabel) ? "PARAM" : builder.paramLabel;
        this.hideParamSyntax = builder.hideParamSyntax;
        ...
        this.required = builder.required && builder.defaultValue == null; //#261 not required if it has a default
        ...
        if (builder.type == null) {
          if (builder.auxiliaryTypes == null || builder.auxiliaryTypes.length == 0) {
            if (this.arity.isVariable || this.arity.max > 1) {
              this.type = String[].class;
            } else if (this.arity.max == 1) {
              this.type = String.class;
            } else {
              this.type = this.isOption() ? boolean.class : String.class;
            }
          } else {
        ...
        if (builder.auxiliaryTypes == null || builder.auxiliaryTypes.length == 0) {
          ...
          } else if (Collection.class.isAssignableFrom(this.type)) { // type is a collection but element type is unspecified
            this.auxiliaryTypes = new Class<?>[] {String.class}; // use String elements
          } else if (Map.class.isAssignableFrom(this.type)) { // type is a map but element type is unspecified
            this.auxiliaryTypes = new Class<?>[] {String.class, String.class}; // use String keys and String values
          } else {
        ...
        if (builder.completionCandidates == null && this.auxiliaryTypes[0].isEnum()) {
          List<String> list = new ArrayList<String>();
          for (Object c : this.auxiliaryTypes[0].getEnumConstants()) { list.add(c.toString()); }
      ...
      public boolean interactive()   { return this.interactive; }

      /** Returns the description template of this option, before variables are rendered.
       * @see Option#description() */
      public String[] description()  { return this.description.clone(); }
       ...
       * @since 3.6 */
      public String descriptionKey()  { return this.descriptionKey; }
       ...
       * @see Option#arity() */
      public Range arity()           { return this.arity; }
      ...
      public String paramLabel()     { return this.paramLabel; }

      /** Returns whether usage syntax decorations around the {@linkplain #paramLabel() paramLabel} should be suppressed.
       * The default is {@code false}: by default, the paramLabel is surrounded with {@code '['} and {@code ']'} characters
       * if the value is optional and followed by ellipses ("...") when multiple values can be specified.
       * @since 3.6.0 */
      public boolean hideParamSyntax()     { return this.hideParamSyntax; }

      /** Returns auxiliary type information used when the {@link #type()} is a generic {@code Collection}, {@code Map} or an abstract class.
       * @see Option#type() */
      public Class<?>[] auxiliaryTypes() { return this.auxiliaryTypes.clone(); }
      ...
      public ITypeConverter<?>[] converters() { return this.converters.clone(); }

      /** Returns a regular expression to split option parameter values or {@code ""} if the value should not be split.
       * @see Option#split() */
      public String splitRegex()     { return this.splitRegex; }
      ...
      public String defaultValueString() {
        ...
        Object value = defaultVal == null ? this.initialValue() : defaultVal;
      ...
      public <T> T setValue(T newValue, CommandLine commandLine) throws PicocliException {
        if (this.setter instanceof MethodBinding) { ((MethodBinding) this.setter).commandLine = commandLine; }
        try {
          return this.setter.set(newValue);
        } catch (PicocliException ex) { throw ex;
        } catch (Exception ex) {        throw new PicocliException("Could not set value (" + newValue + ") for " + this + ": " + ex, ex);
      ...
      public boolean isMultiValue()     { return CommandLine.isMultiValue(this.type()); }
      ...
      public List<String> stringValues() { return Collections.unmodifiableList(this.stringValues); }
       ...
       *      For map properties, {@code "key=value"} values are split into the key and the value part. */
      public List<Object> typedValues() { return Collections.unmodifiableList(this.typedValues); }
      ...
      public List<String> originalStringValues() { return Collections.unmodifiableList(this.originalStringValues); }
      ...
      protected boolean internalShowDefaultValue(boolean usageHelpShowDefaults) {
        if (this.showDefaultValue() == Help.Visibility.ALWAYS)   { return true; }  // override global usage help setting
        if (this.showDefaultValue() == Help.Visibility.NEVER)    { return false; } // override global usage help setting
        if (this.initialValue == null && this.defaultValue() == null) { return false; } // no default value to show
        return usageHelpShowDefaults && !isBoolean(this.type());
      }
      ...
      String[] splitValue(String value, ParserSpec parser, Range arity, int consumed) {
        if (this.splitRegex().length() == 0) { return new String[] {value}; }
        ...
        return this.debug(this.splitRespectingQuotedStrings(value, limit, parser), "Split", value);
      }
      private String[] debug(String[] result, String msg, String value) {
        Tracer t = new Tracer();
        if (t.isDebug()) {t.debug("%s with regex '%s' resulted in %s parts: %s%n", msg, this.splitRegex(), result.length, Arrays.asList(result));}
        return result;
      }
      // @since 3.7
      private String[] splitRespectingQuotedStrings(String value, int limit, ParserSpec parser) {
        ...
        String[] result = splittable.toString().split(this.splitRegex(), limit);
        for (int i = 0; i < result.length; i++) {
          result[i] = this.restoreQuotedValues(result[i], quotedValues, parser);
        }
      ...
      protected int hashCodeImpl() {
        return 17
            + 37 * Assert.hashCode(this.defaultValue)
            + 37 * Assert.hashCode(this.type)
            + 37 * Assert.hashCode(this.arity)
            + 37 * Assert.hashCode(this.hidden)
            + 37 * Assert.hashCode(this.paramLabel)
            + 37 * Assert.hashCode(this.hideParamSyntax)
            + 37 * Assert.hashCode(this.required)
            + 37 * Assert.hashCode(this.splitRegex)
            + 37 * Arrays.hashCode(this.description)
            + 37 * Assert.hashCode(this.descriptionKey)
            + 37 * Arrays.hashCode(this.auxiliaryTypes)
            ;
      }
      ...
      abstract static class Builder<T extends Builder<T>> {
        ...
        private ISetter setter = (ISetter) this.getter;
        ...
        /** Returns auxiliary type information used when the {@link #type()} is a generic {@code Collection}, {@code Map} or an abstract class.
         * @see Option#type() */
        public Class<?>[] auxiliaryTypes() { return this.auxiliaryTypes; }

        /** Returns one or more {@link CommandLine.ITypeConverter type converters} to use to convert the command line
         * argument into a strongly typed value (or key-value pair for map fields). This is useful when a particular
         * option or positional parameter should use a custom conversion that is different from the normal conversion for the arg spec's type.
         * @see Option#converter() */
        public ITypeConverter<?>[] converters() { return this.converters; }
        ...
        public T required(boolean required)          { this.required = required; return this.self(); }

        /** Sets whether this option prompts the user to enter a value on the command line, and returns this builder. */
        public T interactive(boolean interactive)          { this.interactive = interactive; return this.self(); }

        /** Sets the description of this option, used when generating the usage documentation, and returns this builder.
         * @see Option#description() */
        public T description(String... description)  { this.description = Assert.notNull(description, "description").clone(); return this
            .self(); }
         ...
         * @see Parameters#descriptionKey()
         * @since 3.6 */
        public T descriptionKey(String descriptionKey) { this.descriptionKey = descriptionKey; return this.self(); }

        /** Sets how many arguments this option or positional parameter requires, and returns this builder. */
        public T arity(String range)                 { return this.arity(Range.valueOf(range)); }

        /** Sets how many arguments this option or positional parameter requires, and returns this builder. */
        public T arity(Range arity)                  { this.arity = Assert.notNull(arity, "arity"); return this.self(); }

        /** Sets the name of the option or positional parameter used in the usage help message, and returns this builder. */
        public T paramLabel(String paramLabel)       { this.paramLabel = Assert.notNull(paramLabel, "paramLabel"); return this
            .self(); }
         ...
         * if the value is optional and followed by ellipses ("...") when multiple values can be specified.
         * @since 3.6.0 */
        public T hideParamSyntax(boolean hideParamSyntax) { this.hideParamSyntax = hideParamSyntax; return this.self(); }
        ...
        public T auxiliaryTypes(Class<?>... types)   { this.auxiliaryTypes = Assert.notNull(types, "types").clone(); return this
            .self(); }

        /** Sets option/positional param-specific converter (or converters for Maps), and returns this builder. */
        public T converters(ITypeConverter<?>... cs) { this.converters = Assert.notNull(cs, "type converters").clone(); return this
            .self(); }
        ...
        public T splitRegex(String splitRegex)       { this.splitRegex = Assert.notNull(splitRegex, "splitRegex"); return this
            .self(); }
        ...
        public T showDefaultValue(Help.Visibility visibility) {
          this.showDefaultValue = Assert.notNull(visibility, "visibility"); return this
            .self(); }

        /** Sets the completion candidates for this option or positional parameter, and returns this builder.
         * @since 3.2 */
        public T completionCandidates(Iterable<String> completionCandidates) { this.completionCandidates = Assert.notNull(completionCandidates, "completionCandidates"); return this
            .self(); }

        /** Sets whether this option should be excluded from the usage message, and returns this builder. */
        public T hidden(boolean hidden)              { this.hidden = hidden; return this.self(); }
        ...
        public T type(Class<?> propertyType)         { this.type = Assert.notNull(propertyType, "type"); return this
            .self(); }
        ...
        public T defaultValue(String defaultValue)   { this.defaultValue = NO_DEFAULT_VALUE.equals(defaultValue) ? null : defaultValue; return this
            .self(); }
        ...
        public T initialValue(Object initialValue)   { this.initialValue = initialValue; return this.self(); }

        /** Determines whether the option or positional parameter will be reset to the {@link #initialValue()}
         * before parsing new input.*/
        public T hasInitialValue(boolean hasInitialValue)   { this.hasInitialValue = hasInitialValue; return this.self(); }

        /** Sets the {@link IGetter} that is responsible for getting the value of this argument, and returns this builder. */
        public T getter(IGetter getter)              { this.getter = getter; return this.self(); }
        /** Sets the {@link ISetter} that is responsible for modifying the value of this argument, and returns this builder. */
        public T setter(ISetter setter)              { this.setter = setter; return this.self(); }

        /** Sets the string respresentation of this option or positional parameter to the specified value, and returns this builder. */
        public T withToString(String toString)       { this.toString = toString; return this.self(); }
      }
    }
    ...
    public static class OptionSpec extends ArgSpec {
      ...
      @Override public String[] description() {
        if (this.messages() == null) { return super.description(); }
       ...
       * @see Option#names() */
      public String[] names()       { return this.names.clone(); }

      /** Returns the longest {@linkplain #names() option name}. */
      public String longestName() { return Help.ShortestFirst.longestFirst(this.names.clone())[0]; }

      /** Returns the shortest {@linkplain #names() option name}. */
      String shortestName() { return Help.ShortestFirst.sort(this.names.clone())[0]; }
      ...
      public boolean equals(Object obj) {
        ...
        boolean result = super.equalsImpl(other)
            ...
            && this.usageHelp == other.usageHelp
            && this.versionHelp == other.versionHelp
            && new HashSet<String>(Arrays.asList(this.names)).equals(new HashSet<String>(Arrays.asList(other.names)));
        return result;
      }
      public int hashCode() {
        return super.hashCodeImpl()
            + 37 * Assert.hashCode(this.help)
            + 37 * Assert.hashCode(this.usageHelp)
            + 37 * Assert.hashCode(this.versionHelp)
            + 37 * Arrays.hashCode(this.names);
      }
      ...
      public static class Builder extends ArgSpec.Builder<Builder> {
        ...
        public Builder names(String... names)           { this.names = Assert.notNull(names, "names").clone(); return this
            .self(); }

        /** Sets whether this option disables validation of the other arguments, and returns this builder. */
        public Builder help(boolean help)               { this.help = help; return this.self(); }

        /** Sets whether this option allows the user to request usage help, and returns this builder. */
        public Builder usageHelp(boolean usageHelp)     { this.usageHelp = usageHelp; return this.self(); }

        /** Sets whether this option allows the user to request version information, and returns this builder.*/
        public Builder versionHelp(boolean versionHelp) { this.versionHelp = versionHelp; return this.self(); }
      }
    }
    ...
    public static class PositionalParamSpec extends ArgSpec {
      ...
      private PositionalParamSpec(Builder builder) {
        ...
        this.capacity = builder.capacity == null ? Range.parameterCapacity(this.arity(), this.index) : builder.capacity;
        if (this.toString == null) {
      ...
      public Range index()            { return this.index; }
      private Range capacity()        { return this.capacity; }
      public static Builder builder() { return new Builder(); }

      public int hashCode() {
        return super.hashCodeImpl()
            + 37 * Assert.hashCode(this.capacity)
            + 37 * Assert.hashCode(this.index);
      }
      public boolean equals(Object obj) {
        if (obj == this) {
          return true;
      ...
      public static class Builder extends ArgSpec.Builder<Builder> {
        ...
        public Builder index(String range)  { return this.index(Range.valueOf(range)); }

        /** Sets the index or range specifying which of the command line arguments should be assigned to this positional parameter, and returns this builder. */
        public Builder index(Range index)   { this.index = index; return this.self(); }

        Builder capacity(Range capacity)   { this.capacity = capacity; return this.self(); }
      }
    }
      ...
      void addAll(String[] unmatched) {
        if (this.setter != null) {
          try {
            ...
            throw new PicocliException(String.format("Could not invoke setter (%s) with unmatched argument array '%s': %s",
                this.setter, Arrays.toString(unmatched), ex), ex);
          }
        }
        if (this.getter != null) {
          try {
            Collection<String> collection = this.getter.get();
            ...
            throw new PicocliException(String.format("Could not add unmatched argument array '%s' to collection returned by getter (%s): %s",
                Arrays.toString(unmatched), this.getter, ex), ex);
          }
        }
      }
    }
    ...
    static class MethodParam extends AccessibleObject {
      ...
      public Type getParameterizedType() { return this.method.getGenericParameterTypes()[this.paramIndex]; }
      public String getName() { return this.name; }
      public Class<?> getType() { return this.method.getParameterTypes()[this.paramIndex]; }
      public Method getDeclaringExecutable() { return this.method; }
      ...
      @Override public Annotation[] getDeclaredAnnotations() { return this.method.getParameterAnnotations()[this.paramIndex]; }
      @Override public void setAccessible(boolean flag) throws SecurityException {
        this.method.setAccessible(flag); }
      @Override public boolean isAccessible() throws SecurityException { return this.method.isAccessible(); }
      @Override public String toString() { return this.method.toString() + ":" + this.getName(); }
    }
    static class TypedMember {
      ...
      private TypedMember(MethodParam param, Object scope) {
        ...
        this.getter = binding;
        this.setter = binding;
        this.hasInitialValue = this.initializeInitialValue(param);
      }
      ...
      private boolean initializeInitialValue(Object arg) {
        ...
        try {
          if      (this.type == Boolean.TYPE) {
            ...
            this.setter.set(Byte.valueOf((byte) 0)); }
          else if (this.type == Short.TYPE  ) {
            this.setter.set(Short.valueOf((short) 0)); }
          else if (this.type == Integer.TYPE) {
            this.setter.set(Integer.valueOf(0)); }
          else if (this.type == Long.TYPE   ) {
            this.setter.set(Long.valueOf(0L)); }
          else if (this.type == Float.TYPE  ) {
            this.setter.set(Float.valueOf(0f)); }
          else if (this.type == Double.TYPE ) {
            this.setter.set(Double.valueOf(0d)); }
      ...
      boolean isAnnotationPresent(Class<? extends Annotation> annotationClass) { return this.accessible.isAnnotationPresent(annotationClass); }
      <T extends Annotation> T getAnnotation(Class<T> annotationClass) { return this.accessible.getAnnotation(annotationClass); }
      String name()            { return this.name; }
      boolean isArgSpec()      { return this.isOption() || this.isParameter() || (this.isMethodParameter() && !this.isMixin()); }
      boolean isOption()       { return this.isAnnotationPresent(Option.class); }
      boolean isParameter()    { return this.isAnnotationPresent(Parameters.class); }
      boolean isMixin()        { return this.isAnnotationPresent(Mixin.class); }
      boolean isUnmatched()    { return this.isAnnotationPresent(Unmatched.class); }
      boolean isInjectSpec()   { return this.isAnnotationPresent(Spec.class); }
      boolean isMultiValue()   { return CommandLine.isMultiValue(this.getType()); }
      IGetter getter()         { return this.getter; }
      ISetter setter()         { return this.setter; }
      Class<?> getType()       { return this.type; }
      Type getGenericType()    { return this.genericType; }
      public String toString() { return this.accessible.toString(); }
      String toGenericString() { return this.accessible instanceof Field ? ((Field) this.accessible).toGenericString() :
          this.accessible instanceof Method ? ((Method) this.accessible).toGenericString() : this.accessible
          .toString(); }
      boolean isMethodParameter() { return this.accessible instanceof MethodParam; }
      String mixinName()    {
        String annotationName = this.getAnnotation(Mixin.class).name();
        return empty(annotationName) ? this.name() : annotationName;
      }
    ...
    public static class Messages {
      ...
      public String getString(String key, String defaultValue) {
        if (this.rb == null || this.keys.isEmpty()) { return defaultValue; }
        String cmd = this.spec.qualifiedName(".");
        if (this.keys.contains(cmd + "." + key)) { return this.rb.getString(cmd + "." + key); }
        if (this.keys.contains(key)) { return this.rb.getString(key); }
        return defaultValue;
      }
      ...
      public String[] getStringArray(String key, String[] defaultValues) {
        if (this.rb == null || this.keys.isEmpty()) { return defaultValues; }
        String cmd = this.spec.qualifiedName(".");
        List<String> result = addAllWithPrefix(this.rb, cmd + "." + key, this.keys, new ArrayList<String>());
        if (!result.isEmpty()) { return result.toArray(new String[0]); }
        addAllWithPrefix(this.rb, key, this.keys, result);
      ...
      public ResourceBundle resourceBundle() { return this.rb; }
      /** Returns the CommandSpec of this object, never {@code null}. */
      public CommandSpec commandSpec() { return this.spec; }
    }
        ...
        if (member.getType().equals(String[].class)) {
          ...
          return UnmatchedArgsBinding.forStringCollectionSupplier(new IGetter() {
            @SuppressWarnings("unchecked") public <T> T get() throws Exception {
              List<String> result = member.getter().get();
              if (result == null) {
    ...
    private static class FieldBinding implements IGetter, ISetter {
      ...
      public <T> T get() throws PicocliException {
        try {
          @SuppressWarnings("unchecked") T result = (T) this.field.get(this.scope);
          return result;
        } catch (Exception ex) {
    ...
    static class MethodBinding implements IGetter, ISetter {
      ...
      @SuppressWarnings("unchecked") public <T> T get() { return (T) this.currentValue; }
      public <T> T set(T value) throws PicocliException {
        try {
          @SuppressWarnings("unchecked") T result = (T) this.currentValue;
          this.method.invoke(this.scope, value);
          this.currentValue = value;
          return result;
        } catch (InvocationTargetException ex) {
          if (ex.getCause() instanceof PicocliException) { throw (PicocliException) ex.getCause(); }
          throw new ParameterException(this.commandLine, "Could not invoke " + this.method + " with " + value, ex.getCause());
        } catch (Exception ex) {
          throw new ParameterException(this.commandLine, "Could not invoke " + this.method + " with " + value, ex);
        }
      }
    }
    private static class PicocliInvocationHandler implements InvocationHandler {
      ...
      class ProxyBinding implements IGetter, ISetter {
        ...
        @SuppressWarnings("unchecked") public <T> T get() { return (T) PicocliInvocationHandler.this.map.get(this.method.getName()); }
    ...
    private static class ObjectBinding implements IGetter, ISetter {
      ...
      @SuppressWarnings("unchecked") public <T> T get() { return (T) this.value; }
      public <T> T set(T value) {
  ...
  public static class ParseResult {
    ...
    public static class Builder {
      ...
      public Builder add(ArgSpec arg, int position) {
        if (arg.isOption()) {
          this.addOption((OptionSpec) arg);
        } else {
          this.addPositionalParam((PositionalParamSpec) arg, position);
        }
        return this;
      }
      /** Adds the specified {@code OptionSpec} to the list of options that were matched on the command line. */
      public Builder addOption(OptionSpec option) { if (!this.isInitializingDefaultValues) {
      ...
      public Builder addPositionalParam(PositionalParamSpec positionalParam, int position) {
        if (this.isInitializingDefaultValues) { return this; }
        this.positionals.add(positionalParam);
        while (this.positionalParams.size() <= position) {
          this.positionalParams.add(new ArrayList<PositionalParamSpec>()); }
      ...
      public Builder addUnmatched(String arg) {
        this.unmatched.add(arg); return this; }
      /** Adds all elements of the specified command line arguments stack to the list of unmatched command line arguments. */
      public Builder addUnmatched(Stack<String> args) { while (!args.isEmpty()) {
        this.addUnmatched(args.pop()); } return this; }
      ...
      public Builder originalArgs(String[] originalArgs) {
        this.originalArgList.addAll(Arrays.asList(originalArgs)); return this;}

      void addStringValue        (ArgSpec argSpec, String value) { if (!this.isInitializingDefaultValues) { argSpec.stringValues.add(value);} }
      void addOriginalStringValue(ArgSpec argSpec, String value) { if (!this.isInitializingDefaultValues) { argSpec.originalStringValues.add(value); } }
    ...
    private ParseResult(ParseResult.Builder builder) {
      ...
      this.matchedOptions = new ArrayList<OptionSpec>(builder.options);
      this.unmatched = new ArrayList<String>(builder.unmatched);
      this.originalArgs = new ArrayList<String>(builder.originalArgList);
      this.matchedUniquePositionals = new ArrayList<PositionalParamSpec>(builder.positionals);
      this.matchedPositionalParams = new ArrayList<List<PositionalParamSpec>>(builder.positionalParams);
    ...
    public OptionSpec matchedOption(char shortName) { return CommandSpec.findOption(shortName, this.matchedOptions); }
    ...
    public OptionSpec matchedOption(String name) { return CommandSpec.findOption(name, this.matchedOptions); }
    ...
    public PositionalParamSpec matchedPositional(int position) {
      if (this.matchedPositionalParams.size() <= position || this.matchedPositionalParams.get(position).isEmpty()) { return null; }
    ...
    public List<PositionalParamSpec> matchedPositionals(int position) {
      if (this.matchedPositionalParams.size() <= position) { return Collections.emptyList(); }
      return this.matchedPositionalParams.get(position) == null ? Collections.emptyList() :
          this.matchedPositionalParams.get(position);
    }
    /** Returns the {@code CommandSpec} for the matched command. */
    public CommandSpec commandSpec()                    { return this.commandSpec; }
    ...
    public boolean hasMatchedOption(char shortName)     { return this.matchedOption(shortName) != null; }
    /** Returns whether an option whose aliases include the specified name was matched on the command line.
     * @param name used to search the matched options. May be an alias of the option name that was actually specified on the command line.
     *      The specified name may include option name prefix characters or not. */
    public boolean hasMatchedOption(String name)        { return this.matchedOption(name) != null; }
    /** Returns whether the specified option was matched on the command line. */
    public boolean hasMatchedOption(OptionSpec option)  { return this.matchedOptions.contains(option); }

    /** Returns whether a positional parameter was matched at the specified position. */
    public boolean hasMatchedPositional(int position)   { return this.matchedPositional(position) != null; }
    /** Returns whether the specified positional parameter was matched on the command line. */
    public boolean hasMatchedPositional(PositionalParamSpec positional) { return this.matchedUniquePositionals.contains(positional); }

    /** Returns a list of matched options, in the order they were found on the command line. */
    public List<OptionSpec> matchedOptions()            { return Collections.unmodifiableList(this.matchedOptions); }

    /** Returns a list of matched positional parameters. */
    public List<PositionalParamSpec> matchedPositionals() { return Collections.unmodifiableList(
        this.matchedUniquePositionals); }

    /** Returns a list of command line arguments that did not match any options or positional parameters. */
    public List<String> unmatched()                     { return Collections.unmodifiableList(this.unmatched); }

    /** Returns the command line arguments that were parsed. */
    public List<String> originalArgs()                  { return Collections.unmodifiableList(this.originalArgs); }
    ...
    public <T> T matchedOptionValue(char shortName, T defaultValue)    { return this
        .matchedOptionValue(this.matchedOption(shortName), defaultValue); }
    /** Returns the command line argument value of the option with the specified name, converted to the {@linkplain OptionSpec#type() type} of the option, or the specified default value if no option with the specified name was matched. */
    public <T> T matchedOptionValue(String name, T defaultValue)       { return this
        .matchedOptionValue(this.matchedOption(name), defaultValue); }
    ...
    public <T> T matchedPositionalValue(int position, T defaultValue)  { return this.matchedPositionalValue(
        this.matchedPositional(position), defaultValue); }
    ...
    public boolean hasSubcommand()          { return this.subcommand != null; }
    ...
    public ParseResult subcommand()         { return this.subcommand; }
    ...
    public boolean isUsageHelpRequested()   { return this.usageHelpRequested; }
    ...
    public boolean isVersionHelpRequested() { return this.versionHelpRequested; }
  ...
  private class Interpreter {
    ...
    private ParserSpec config() { return CommandLine.this.commandSpec.parser(); }
    /**
    ...
    List<CommandLine> parse(String... args) {
      ...
      if (CommandLine.this.tracer.isInfo()) {
        CommandLine.this.tracer.info("Picocli version: %s%n", versionString());}
      if (CommandLine.this.tracer.isInfo()) {
      ...
      if (CommandLine.this.tracer.isDebug()){
        CommandLine.this.tracer.debug("(ANSI is %s by default: TTY=%s, isXTERM=%s, hasOSTYPE=%s, isWindows=%s, JansiConsoleInstalled=%s)%n", Help.Ansi.ansiPossible() ? "enabled" : "disabled", Help.Ansi.isTTY(), Help.Ansi.isXterm, Help.Ansi.hasOsType, Help.Ansi.isWindows, Help.Ansi.isJansiConsoleInstalled());}
      ...
      if (!file.canRead()) {
        if (CommandLine.this.tracer.isInfo()) {
          CommandLine.this.tracer
              .info("File %s does not exist or cannot be read; treating argument literally%n", fileName);}
      ...
      try {
        ...
        if (this.useSimplifiedAtFiles()) {
          ...
          if (CommandLine.this.commandSpec.parser().atFileCommentChar() != null) {
            tok.commentChar(CommandLine.this.commandSpec.parser().atFileCommentChar());
          }
    ...
    private void clear() {
      ...
      for (OptionSpec option : CommandLine.this.getCommandSpec().options())                           {
        this.clear(option); }
      for (PositionalParamSpec positional : CommandLine.this.getCommandSpec().positionalParameters()) {
    ...
    private void clear(ArgSpec argSpec) {
      ...
      if (argSpec.hasInitialValue()) {
        try {
          ...
          CommandLine.this.tracer
              .warn("Could not set initial value for %s of type %s to %s: %s%n", argSpec, argSpec.type(), String.valueOf(argSpec.initialValue()), ex);
        }
      } else {
    ...
    private void parse(List<CommandLine> parsedCommands, Stack<String> argumentStack, String[] originalArgs, List<Object> nowProcessing) {
      this.clear(); // first reset any state in case this CommandLine instance is being reused
      if (CommandLine.this.tracer.isDebug()) {
        CommandLine.this.tracer.debug("Initializing %s: %d options, %d positional parameters, %d required, %d subcommands.%n",
          CommandLine.this.commandSpec.toString(), new HashSet<ArgSpec>(CommandLine.this.commandSpec.optionsMap().values()).size(),
          CommandLine.this.commandSpec.positionalParameters().size(), CommandLine.this.commandSpec.requiredArgs().size(), CommandLine.this.commandSpec
              .subcommands().size());}
      parsedCommands.add(CommandLine.this);
      List<ArgSpec> required = new ArrayList<ArgSpec>(CommandLine.this.commandSpec.requiredArgs());
      ...
      if (!this.parseResult.unmatched.isEmpty()) {
        ...
        for (UnmatchedArgsBinding unmatchedArgsBinding : CommandLine.this.getCommandSpec().unmatchedArgsBindings()) {
          unmatchedArgsBinding.addAll(unmatched.clone());
        }
        if (!CommandLine.this.isUnmatchedArgumentsAllowed()) {
          this.maybeThrow(new UnmatchedArgumentException(CommandLine.this, Collections.unmodifiableList(
            this.parseResult.unmatched))); }
        if (CommandLine.this.tracer.isInfo()) {
    ...
    private void applyDefaultValues(List<ArgSpec> required) throws Exception {
      ...
      for (OptionSpec option              : CommandLine.this.commandSpec.options())              {
        this.applyDefault(
          CommandLine.this.commandSpec.defaultValueProvider(), option,     required); }
      for (PositionalParamSpec positional : CommandLine.this.commandSpec.positionalParameters()) {
        this.applyDefault(
          CommandLine.this.commandSpec.defaultValueProvider(), positional, required); }
    ...
    private void applyDefault(IDefaultValueProvider defaultValueProvider,
      ...
      this.applyOption(arg, LookBehind.SEPARATE, arity, this.stack(defaultValue), new HashSet<ArgSpec>(), arg.toString);
      required.remove(arg);
    }
    ...
    private void processArguments(List<CommandLine> parsedCommands,
      ...
      while (!args.isEmpty()) {
        ...
        String arg = args.pop();
        if (CommandLine.this.tracer.isDebug()) {
          CommandLine.this.tracer.debug("Processing argument '%s'. Remainder=%s%n", arg, reverse(copy(args)));}
        ...
        if (CommandLine.this.commandSpec.subcommands().containsKey(arg)) {
          ...
          if (!this.isAnyHelpRequested() && !required.isEmpty()) { // ensure current command portion is valid
          ...
          this.parseResult.subcommand(subcommand.interpreter.parseResult.build());
        ...
        if (separatorIndex > 0) {
          ...
          if (CommandLine.this.commandSpec.optionsMap().containsKey(key) && !CommandLine.this.commandSpec.optionsMap().containsKey(arg)) {
            ...
            if (CommandLine.this.tracer.isDebug()) {
              CommandLine.this.tracer
                  .debug("'%s' contains separator '%s' but '%s' is not a known option%n", arg, separator, key);}
          }
        } else {
          if (CommandLine.this.tracer.isDebug()) {
        ...
        else if (this.config().posixClusteredShortOptionsAllowed() && arg.length() > 2 && arg.startsWith("-")) {
          if (CommandLine.this.tracer.isDebug()) {
        ...
        // The argument could not be interpreted as an option: process it as a positional argument
          ...
          if (CommandLine.this.commandSpec.resemblesOption(arg, CommandLine.this.tracer)) {
            this.handleUnmatchedArgument(args); continue; } // #149
          if (CommandLine.this.tracer.isDebug()) {
            CommandLine.this.tracer
                .debug("No option named '%s' found. Processing remainder as positional parameters%n", arg);}
    ...
    private void processPositionalParameter(Collection<ArgSpec> required, Set<ArgSpec> initialized, Stack<String> args) throws Exception {
      if (CommandLine.this.tracer.isDebug()) {
        CommandLine.this.tracer.debug("Processing next arg as a positional parameter at index=%d. Remainder=%s%n",
          this.position, reverse(copy(args)));}
      if (this.config().stopAtPositional()) {
        if (!this.endOfOptions && CommandLine.this.tracer.isDebug()) {
          CommandLine.this.tracer.debug("Parser was configured with stopAtPositional=true, treating remaining arguments as positional parameters.%n");}
        this.endOfOptions = true;
      }
      int argsConsumed = 0;
      int interactiveConsumed = 0;
      int originalNowProcessingSize = this.parseResult.nowProcessing.size();
      for (PositionalParamSpec positionalParam : CommandLine.this.commandSpec.positionalParameters()) {
        Range indexRange = positionalParam.index();
        if (!indexRange.contains(this.position) || positionalParam.typedValueAtPosition.get(this.position) != null) {
          continue;
        }
        Stack<String> argsCopy = copy(args);
        Range arity = positionalParam.arity();
        if (CommandLine.this.tracer.isDebug()) {
          CommandLine.this.tracer.debug("Position %d is in index range %s. Trying to assign args to %s, arity=%s%n",
            this.position, indexRange, positionalParam, arity);}
        if (!this.assertNoMissingParameters(positionalParam, arity, argsCopy)) { break; } // #389 collectErrors parsing
        int originalSize = argsCopy.size();
        int actuallyConsumed = this
            .applyOption(positionalParam, LookBehind.SEPARATE, arity, argsCopy, initialized, "args[" + indexRange + "] at position " + this.position);
      ...
      if (CommandLine.this.tracer.isDebug()) {
        CommandLine.this.tracer
            .debug("Consumed %d arguments and %d interactive values, moving position to index %d.%n", argsConsumed, interactiveConsumed,
          this.position);}
    ...
    private void processStandaloneOption(Collection<ArgSpec> required,
      ...
      ArgSpec argSpec = CommandLine.this.commandSpec.optionsMap().get(arg);
    ...
    private void processClusteredShortOptions(Collection<ArgSpec> required,
      ...
      boolean first = true;
      do {
        if (cluster.length() > 0 && CommandLine.this.commandSpec.posixOptionsMap().containsKey(cluster.charAt(0))) {
          ArgSpec argSpec = CommandLine.this.commandSpec.posixOptionsMap().get(cluster.charAt(0));
          Range arity = argSpec.arity();
          String argDescription = "option " + prefix + cluster.charAt(0);
          if (CommandLine.this.tracer.isDebug()) {
            CommandLine.this.tracer.debug("Found option '%s%s' in %s: %s, arity=%s%n", prefix, cluster.charAt(0), arg,
              argSpec, arity);}
          required.remove(argSpec);
          ...
          if (cluster.startsWith(this.config().separator())) {// attached with separator, like -f=FILE or -v=true
          ...
          if (first) {
            ...
            this.parseResult.nowProcessing.set(this.parseResult.nowProcessing.size() - 1, argSpec); // replace
          }
          ...
          if (arg.endsWith(cluster)) {
            ...
            if (args.peek().equals(arg)) { // #149 be consistent between unmatched short and long options
              ...
              if (CommandLine.this.commandSpec.resemblesOption(arg, CommandLine.this.tracer)) {
                this.handleUnmatchedArgument(args); return; } // #149
              this.processPositionalParameter(required, initialized, args);
              return;
            }
    ...
    private int applyOption(ArgSpec argSpec,
      ...
      if (consumeOnlyOne) {
        ...
        if (!this.assertNoMissingParameters(argSpec, arity, args)) { return 0; } // #389 collectErrors parsing
      }

      if (argSpec.interactive()) {
        String name = argSpec.isOption() ? ((OptionSpec) argSpec).longestName() : "position " + this.position;
        ...
        char[] value = this.readPassword(prompt, false);
        if (CommandLine.this.tracer.isDebug()) {
      ...
      if (argSpec.type().isArray()) {
        result = this.applyValuesToArrayField(argSpec, lookBehind, arity, workingStack, initialized, argDescription);
      } else if (Collection.class.isAssignableFrom(argSpec.type())) {
        result = this.applyValuesToCollectionField(argSpec, lookBehind, arity, workingStack, initialized, argDescription);
      } else if (Map.class.isAssignableFrom(argSpec.type())) {
        result = this.applyValuesToMapField(argSpec, lookBehind, arity, workingStack, initialized, argDescription);
      } else {
        result = this
            .applyValueToSingleValuedField(argSpec, lookBehind, arity, workingStack, initialized, argDescription);
      }
    ...
    private int applyValueToSingleValuedField(ArgSpec argSpec,
      ...
      String value = args.isEmpty() ? null : this.trim(args.pop()); // unquote the value
      ...
      if (arity.max == 0 && !arity.isUnspecified && lookBehind == LookBehind.ATTACHED_WITH_SEPARATOR) { // #509
        throw new MaxValuesExceededException(CommandLine.this, this.optionDescription("", argSpec, 0) +
        ...
        if (cls == Boolean.class || cls == Boolean.TYPE) {
          ...
          if (arity.max > 0 && "true".equalsIgnoreCase(value) || "false".equalsIgnoreCase(value)) {
            ...
            if (CommandLine.this.commandSpec.parser().toggleBooleanFlags()) {
              Boolean currentValue = argSpec.getValue();
      ...
      if (CommandLine.this.tracer.isInfo()) {
        CommandLine.this.tracer
            .info(traceMessage, argSpec.toString(), String.valueOf(oldValue), String.valueOf(newValue), argDescription); }
      argSpec.setValue(newValue, CommandLine.this.commandSpec.commandLine());
      this.parseResult.addOriginalStringValue(argSpec, value);// #279 track empty string value if no command line argument was consumed
    ...
    private int applyValuesToMapField(ArgSpec argSpec,
      ...
      @SuppressWarnings("unchecked") Map<Object, Object> map = argSpec.getValue();
      if (map == null || (!map.isEmpty() && !initialized.contains(argSpec))) {
        CommandLine.this.tracer
            .debug("Initializing binding for %s with empty %s%n", this.optionDescription("", argSpec, 0), argSpec.type().getSimpleName());
        map = this.createMap(argSpec.type()); // map class
        argSpec.setValue(map, CommandLine.this.commandSpec.commandLine());
      }
      initialized.add(argSpec);
    ...
    private void consumeMapArguments(ArgSpec argSpec,
      ...
      for (int i = consumed; consumed < arity.max && !args.isEmpty(); i++) {
        ...
        Map<Object, Object> typedValuesAtPosition = new LinkedHashMap<Object, Object>();
        this.parseResult.addTypedValues(argSpec, currentPosition++, typedValuesAtPosition);
        if (!this.canConsumeOneMapArgument(argSpec, arity, consumed, args.peek(), classes, keyConverter, valueConverter, argDescription)) {
    ...
    private void consumeOneMapArgument(ArgSpec argSpec,
      ...
      for (String value : values) {
        ...
        if (CommandLine.this.tracer.isInfo()) {
          CommandLine.this.tracer.info("Putting [%s : %s] in %s<%s, %s> %s for %s%n", String.valueOf(mapKey), String.valueOf(mapValue),
    ...
    private boolean canConsumeOneMapArgument(ArgSpec argSpec, Range arity, int consumed,
      ...
      try {
        ...
        CommandLine.this.tracer
            .debug("$s cannot be assigned to %s: type conversion fails: %s.%n", raw, argDescription, ex.getMessage());
        return false;
      }
    }
    ...
    private String[] splitKeyValue(ArgSpec argSpec, String value) {
      ...
      if (keyValue.length < 2) {
        ...
        if (splitRegex.length() == 0) {
          throw new ParameterException(CommandLine.this, "Value for option " + this.optionDescription("",
    ...
    private void assertNoMissingMandatoryParameter(ArgSpec argSpec, Stack<String> args, int i, Range arity) {
      if (!this.varargCanConsumeNextValue(argSpec, args.peek())) {
        ...
        throw new MissingParameterException(CommandLine.this, argSpec, "Expected parameter " + desc + "for " + this
            .optionDescription("", argSpec, -1) + " but found '" + args.peek() + "'");
      }
    }
    private int applyValuesToArrayField(ArgSpec argSpec,
      ...
      argSpec.setValue(array, CommandLine.this.commandSpec.commandLine());
      this.parseResult.add(argSpec, this.position);
    ...
    private int applyValuesToCollectionField(ArgSpec argSpec,
      ...
      if (collection == null || (!collection.isEmpty() && !initialized.contains(argSpec))) {
        CommandLine.this.tracer
            .debug("Initializing binding for %s with empty %s%n", this.optionDescription("", argSpec, 0), argSpec.type().getSimpleName());
        collection = this.createCollection(argSpec.type()); // collection type
        argSpec.setValue(collection, CommandLine.this.commandSpec.commandLine());
      }
      initialized.add(argSpec);
    ...
    private List<Object> consumeArguments(ArgSpec argSpec,
      ...
      for (int i = consumed; consumed < arity.max && !args.isEmpty(); i++) {
        ...
        List<Object> typedValuesAtPosition = new ArrayList<Object>();
        this.parseResult.addTypedValues(argSpec, currentPosition++, typedValuesAtPosition);
        if (!this.canConsumeOneArgument(argSpec, arity, consumed, args.peek(), type, argDescription)) {
    ...
    private int consumeOneArgument(ArgSpec argSpec,
      ...
      for (int j = 0; j < values.length; j++) {
        ...
        if (CommandLine.this.tracer.isInfo()) {
          CommandLine.this.tracer
              .info("Adding [%s] to %s for %s%n", String.valueOf(result.get(result.size() - 1)), argSpec.toString(), argDescription);
        }
    ...
    private boolean canConsumeOneArgument(ArgSpec argSpec, Range arity, int consumed, String arg, Class<?> type, String argDescription) {
      ITypeConverter<?> converter = this.getTypeConverter(type, argSpec, 0);
      try {
        String[] values = argSpec.splitValue(this.trim(arg), CommandLine.this.commandSpec.parser(), arity, consumed);
        ...
        CommandLine.this.tracer
            .debug("$s cannot be assigned to %s: type conversion fails: %s.%n", arg, argDescription, ex.getMessage());
        return false;
      }
    }
    ...
    private boolean varargCanConsumeNextValue(ArgSpec argSpec, String nextValue) {
      if (this.endOfOptions && argSpec.isPositional()) { return true; }
    ...
    private boolean isOption(String arg) {
      ...
      if (CommandLine.this.commandSpec.optionsMap().containsKey(arg)) { // -v or -f or --file (not attached to param or other option)
        return true;
      }
      ...
      if (separatorIndex > 0) { // -f=FILE or --file==FILE (attached to param via separator)
        if (CommandLine.this.commandSpec.optionsMap().containsKey(arg.substring(0, separatorIndex))) {
          return true;
        }
      }
      return (arg.length() > 2 && arg.startsWith("-") && CommandLine.this.commandSpec.posixOptionsMap().containsKey(arg.charAt(1)));
    }
    ...
    private boolean isAnyHelpRequested() { return this.isHelpRequested || this.parseResult.versionHelpRequested || this.parseResult.usageHelpRequested; }
    ...
    private void updateHelpRequested(ArgSpec argSpec) {
      if (argSpec.isOption()) {
        ...
        this.parseResult.versionHelpRequested |= this.is(argSpec, "versionHelp", option.versionHelp());
        this.parseResult.usageHelpRequested   |= this.is(argSpec, "usageHelp", option.usageHelp());
      }
    }
    private boolean is(ArgSpec p, String attribute, boolean value) {
      if (value) { if (CommandLine.this.tracer.isInfo()) {
    ...
    private ITypeConverter<?> getTypeConverter(final Class<?> type, ArgSpec argSpec, int index) {
      ...
      if (this.converterRegistry.containsKey(type)) { return this.converterRegistry.get(type); }
      if (type.isEnum()) {
    ...
    private boolean assertNoMissingParameters(ArgSpec argSpec, Range arity, Stack<String> args) {
      ...
      if (arity.min > available) {
        if (arity.min == 1) {
          if (argSpec.isOption()) {
            this.maybeThrow(new MissingParameterException(CommandLine.this, argSpec, "Missing required parameter for " +
                this.optionDescription("", argSpec, 0)));
            return false;
          }
          ...
          String names = ": ";
          int count = 0;
          List<PositionalParamSpec> positionalParameters = CommandLine.this.commandSpec.positionalParameters();
          ...
          this.maybeThrow(new MissingParameterException(CommandLine.this, argSpec, this.optionDescription("", argSpec, 0) +
    ...
    private String unquote(String value) {
      if (!CommandLine.this.commandSpec.parser().trimQuotes()) { return value; }
      return value == null
          ? null
    ...
    static class ReflectionConverter implements ITypeConverter<Object> {
      ...
      public Object convert(String s) {
        try {
          ...
          throw new TypeConversionException(String.format("cannot convert '%s' to %s (%s)", s, this.method.getReturnType(), e));
        }
      }
    }
  ...
  public static class Help {
    ...
    public Help(CommandSpec commandSpec, ColorScheme colorScheme) {
      ...
      this.parameterLabelRenderer = this.createDefaultParamLabelRenderer(); // uses help separator
     ...
     * @since 3.0 */
    CommandSpec commandSpec() { return this.commandSpec; }

    /** Returns the {@code ColorScheme} model that this Help was constructed with.
     * @since 3.0 */
    public ColorScheme colorScheme() { return this.colorScheme; }
    ...
    public IParamLabelRenderer parameterLabelRenderer() {return this.parameterLabelRenderer;}
        ...
        for (Map.Entry<String, CommandLine> entry : commands.entrySet()) {
          ...
          if (!entry.getValue().getCommandSpec().usageMessage().hidden()) {
            ...
            if (aliases != null) { // otherwise we already processed this command by another alias
              this.addSubcommand(aliases, entry.getValue());
            }
          }
        }
      }
    ...
    Help addSubcommand(List<String> commandNames, CommandLine commandLine) {
      ...
      this.commands.put(all.substring(1, all.length() - 1), new Help(commandLine.commandSpec, this.colorScheme).withCommandNames(commandNames));
      return this;
    }
    ...
    @Deprecated public Help addSubcommand(String commandName, Object command) {
      this.commands.put(commandName, new Help(CommandSpec.forAnnotatedObject(command, this.commandSpec.commandLine().factory)));
      return this;
    }

    List<OptionSpec> options() { return this.commandSpec.options(); }
    List<PositionalParamSpec> positionalParameters() { return this.commandSpec.positionalParameters(); }
    String commandName() { return this.commandSpec.name(); }
     ...
     */
    @Deprecated public String synopsis() { return this.synopsis(0); }
    ...
    public String synopsis(int synopsisHeadingLength) {
      if (!empty(this.commandSpec.usageMessage().customSynopsis())) { return this.customSynopsis(); }
      return this.commandSpec.usageMessage().abbreviateSynopsis() ? this.abbreviatedSynopsis()
    ...
    public String abbreviatedSynopsis() {
      StringBuilder sb = new StringBuilder();
      if (!this.commandSpec.optionsMap().isEmpty()) { // only show if annotated object actually has options
        sb.append(" [OPTIONS]");
      }
      // sb.append(" [--] "); // implied
      for (PositionalParamSpec positionalParam : this.commandSpec.positionalParameters()) {
      ...
      return this.colorScheme.commandText(this.commandSpec.qualifiedName()).toString()
    ...
    public String detailedSynopsis(int synopsisHeadingLength, Comparator<OptionSpec> optionSort, boolean clusterBooleanOptions) {
      Text optionText = this.ansi().new Text(0);
      List<OptionSpec> options = new ArrayList<OptionSpec>(this.commandSpec.options()); // iterate in declaration order
      if (optionSort != null) {
      ...
      for (OptionSpec option : options) {
        if (!option.hidden()) {
          Text name = this.colorScheme.optionText(option.shortestName());
          Text param = this.parameterLabelRenderer().renderParameterLabel(option, this.colorScheme.ansi(), this.colorScheme.optionParamStyles);
      ...
      for (PositionalParamSpec positionalParam : this.commandSpec.positionalParameters()) {
        if (!positionalParam.hidden()) {
          optionText = optionText.concat(" ");
          Text label = this.parameterLabelRenderer().renderParameterLabel(positionalParam, this.colorScheme.ansi(),
              this.colorScheme.parameterStyles);
    ...
    public int synopsisHeadingLength() {
      String[] lines = Ansi.OFF.new Text(this.commandSpec.usageMessage().synopsisHeading()).toString().split("\\r?\\n|\\r|%n", -1);
    ...
    public String optionList() {
      Comparator<OptionSpec> sortOrder = this.commandSpec.usageMessage().sortOptions()
          ? createShortOptionNameComparator()
          : null;

      return this
          .optionList(this.createLayout(this.calcLongOptionColumnWidth()), sortOrder, this.parameterLabelRenderer());
    }

    private int calcLongOptionColumnWidth() {
      int max = 0;
      IOptionRenderer optionRenderer = new DefaultOptionRenderer(false, " ");
      for (OptionSpec option : this.commandSpec.options()) {
        Text[][] values = optionRenderer.render(option, this.parameterLabelRenderer(), this.colorScheme);
      ...
      for (PositionalParamSpec positional : this.commandSpec.positionalParameters()) {
        Text[][] values = paramRenderer.render(positional, this.parameterLabelRenderer(), this.colorScheme);
        int len = values[0][3].length;
        if (len < Help.defaultOptionsColumnWidth - 3) { max = Math.max(max, len); }
      }
      return max + 3;
    ...
    public String optionList(Layout layout, Comparator<OptionSpec> optionSort, IParamLabelRenderer valueLabelRenderer) {
      List<OptionSpec> options = new ArrayList<OptionSpec>(this.commandSpec.options()); // options are stored in order of declaration
      if (optionSort != null) {
    ...
    private int width() { return this.commandSpec.usageMessage().width(); }
    ...
    public String customSynopsis(Object... params) {
      return join(this.ansi(), this.width(), this.commandSpec.usageMessage().customSynopsis(), new StringBuilder(), params).toString();
    }
    ...
    public String description(Object... params) {
      return join(this.ansi(), this.width(), this.commandSpec.usageMessage().description(), new StringBuilder(), params).toString();
    }
    ...
    public String header(Object... params) {
      return join(this.ansi(), this.width(), this.commandSpec.usageMessage().header(), new StringBuilder(), params).toString();
    }
    ...
    public String footer(Object... params) {
      return join(this.ansi(), this.width(), this.commandSpec.usageMessage().footer(), new StringBuilder(), params).toString();
    }
    ...
    public String headerHeading(Object... params) {
      return heading(this.ansi(), this.width(), this.commandSpec.usageMessage().headerHeading(), params);
    }
    ...
    public String synopsisHeading(Object... params) {
      return heading(this.ansi(), this.width(), this.commandSpec.usageMessage().synopsisHeading(), params);
    }
    ...
    public String descriptionHeading(Object... params) {
      return empty(this.commandSpec.usageMessage().descriptionHeading()) ? "" : heading(this.ansi(), this.width(),
          this.commandSpec.usageMessage().descriptionHeading(), params);
    }
    ...
    public String parameterListHeading(Object... params) {
      return this.commandSpec.positionalParameters().isEmpty() ? "" : heading(this.ansi(), this.width(),
          this.commandSpec.usageMessage().parameterListHeading(), params);
    }
    ...
    public String optionListHeading(Object... params) {
      return this.commandSpec.optionsMap().isEmpty() ? "" : heading(this.ansi(), this.width(),
          this.commandSpec.usageMessage().optionListHeading(), params);
    }
    ...
    public String commandListHeading(Object... params) {
      return this.commands.isEmpty() ? "" : heading(this.ansi(), this.width(), this.commandSpec.usageMessage().commandListHeading(), params);
    }
    ...
    public String footerHeading(Object... params) {
      return heading(this.ansi(), this.width(), this.commandSpec.usageMessage().footerHeading(), params);
    }
    ...
    public String commandList() {
      ...
      Help.TextTable textTable = Help.TextTable.forColumns(this.ansi(),
          new Help.Column(commandLength + 2, 2, Help.Column.Overflow.SPAN),
          new Help.Column(this.width() - (commandLength + 2), 2, Help.Column.Overflow.WRAP));
      ...
      for (Map.Entry<String, Help> entry : this.commands.entrySet()) {
        ...
        Text[] lines = this.ansi().text(format(header)).splitLines();
    ...
    private Text commandNamesText() {
      Text result = this.colorScheme.commandText(this.aliases.get(0));
      for (int i = 1; i < this.aliases.size(); i++) {
        result = result.concat(", ").concat(this.colorScheme.commandText(this.aliases.get(i)));
      }
      return result;
    }
    ...
    public Layout createDefaultLayout() {
      return this.createLayout(Help.defaultOptionsColumnWidth);
    }

    private Layout createLayout(int longOptionsColumnWidth) {
      return new Layout(
          this.colorScheme, TextTable.forDefaultColumns(this.colorScheme.ansi(), longOptionsColumnWidth, this.width()),
    ...
    public IOptionRenderer createDefaultOptionRenderer() {
      return new DefaultOptionRenderer(
          this.commandSpec.usageMessage.showDefaultValues(), "" + this.commandSpec.usageMessage().requiredOptionMarker());
    }
     ...
     */
    public Ansi ansi() { return this.colorScheme.ansi; }
    ...
    static class DefaultOptionRenderer implements IOptionRenderer {
      ...
      public Text[][] render(OptionSpec option, IParamLabelRenderer paramLabelRenderer, ColorScheme scheme) {
        ...
        Text longOptionText = this.createLongOptionText(option, paramLabelRenderer, scheme, longOption);
      ...
      private Text[][] renderDescriptionLines(OptionSpec option,
        ...
        boolean[] showDefault = {option.internalShowDefaultValue(this.showDefaultValues)};
        ...
        result.add(new Text[] { scheme.optionText(requiredOption), scheme.optionText(shortOption),
            scheme.ansi().new Text(this.sep), longOptionText, descriptionFirstLines[0] });
    ...
    static class DefaultParameterRenderer implements IParameterRenderer {
      ...
      public Text[][] render(PositionalParamSpec param, IParamLabelRenderer paramLabelRenderer, ColorScheme scheme) {
        ...
        Text requiredParameter = scheme.parameterText(param.arity().min > 0 ? this.requiredMarker : "");

        Text EMPTY = Ansi.EMPTY_TEXT;
        boolean[] showDefault = {param.internalShowDefaultValue(this.showDefaultValues)};
        List<Text[]> result = new ArrayList<Text[]>();
    ...
    static class DefaultParamLabelRenderer implements IParamLabelRenderer {
      ...
      public String separator() { return this.commandSpec.parser().separator(); }
      public Text renderParameterLabel(ArgSpec argSpec, Ansi ansi, List<IStyle> styles) {
        Range capacity = argSpec.isOption() ? argSpec.arity() : ((PositionalParamSpec)argSpec).capacity();
        if (capacity.max == 0) { return ansi.new Text(""); }
        if (argSpec.hideParamSyntax()) { return ansi.apply((argSpec.isOption() ? this.separator() : "") + argSpec.paramLabel(), styles); }
        ...
        boolean unlimitedSplit = !empty(split) && !this.commandSpec.parser().limitSplit();
        boolean limitedSplit =   !empty(split) && this.commandSpec.parser().limitSplit();
        ...
        String optionSeparator = argSpec.isOption() ? this.separator() : "";
    ...
    public static class Layout {
      ...
      public void addOption(OptionSpec option, IParamLabelRenderer paramLabelRenderer) {
        Text[][] values = this.optionRenderer.render(option, paramLabelRenderer, this.colorScheme);
      ...
      public void addPositionalParameter(PositionalParamSpec param, IParamLabelRenderer paramLabelRenderer) {
        Text[][] values = this.parameterRenderer.render(param, paramLabelRenderer, this.colorScheme);
        this.layout(param, values);
      }
      /** Returns the section of the usage help message accumulated in the TextTable owned by this layout. */
      @Override public String toString() { return this.table.toString(); }
    }
    /** Sorts short strings before longer strings. */
    ...
    public static class TextTable {
      ...
      /** The column definitions of this table. */
      public Column[] columns() { return this.columns.clone(); }
       ...
       * @since 2.0 */
      public Text textAt(int row, int col) { return this.columnValues.get(col + (row * this.columns.length)); }
      ...
      @Deprecated public Text cellAt(int row, int col) { return this.textAt(row, col); }

      /** Returns the current number of rows of this {@code TextTable}.
       * @return the current number of rows in this TextTable */
      public int rowCount() { return this.columnValues.size() / this.columns.length; }
      ...
      public void addRowValues(Text... values) {
        ...
        for (int col = 0; col < values.length; col++) {
          int row = this.rowCount() - 1;// write to last row: previous value may have wrapped to next row
      ...
      private int unindent(Text[] values) {
        if (this.columns.length <= LONG_OPTION_COLUMN) { return 0; }
        int oldIndent = this.columns[LONG_OPTION_COLUMN].indent;
        if ("=".equals(values[OPTION_SEPARATOR_COLUMN].toString())) {
          this.columns[LONG_OPTION_COLUMN].indent = 0;
        }
        return oldIndent;
      }
      private void reindent(int oldIndent) {
        if (this.columns.length <= LONG_OPTION_COLUMN) { return; }
        this.columns[LONG_OPTION_COLUMN].indent = oldIndent;
      }
      ...
      public Cell putValue(int row, int col, Text value) {
        ...
        case SPAN:
          ...
          do {
            ...
            if (value.length > 0 && col >= this.columns.length) { // we filled up all columns on this row
              this.addEmptyRow();
              row++;
              col = startColumn;
      ...
      public StringBuilder toString(StringBuilder text) {
        ...
        for (int i = 0; i < this.columnValues.size(); i++) {
          Text column = this.columnValues.get(i);
      ...
      public String toString() { return this.toString(new StringBuilder()).toString(); }
    }
    ...
    public static class ColorScheme {
      ...
      public ColorScheme commands(IStyle... styles)     { return this.addAll(this.commandStyles, styles); }
       ...
       * @return this color scheme to enable method chaining for a more fluent API */
      public ColorScheme options(IStyle... styles)      { return this.addAll(this.optionStyles, styles);}
       ...
       * @return this color scheme to enable method chaining for a more fluent API */
      public ColorScheme parameters(IStyle... styles)   { return this.addAll(this.parameterStyles, styles);}
       ...
       * @return this color scheme to enable method chaining for a more fluent API */
      public ColorScheme optionParams(IStyle... styles) { return this.addAll(this.optionParamStyles, styles);}
      ...
      public Ansi.Text commandText(String command)         { return this.ansi().apply(command, this.commandStyles); }
      ...
      public Ansi.Text optionText(String option)           { return this.ansi().apply(option, this.optionStyles); }
      ...
      public Ansi.Text parameterText(String parameter)     { return this.ansi().apply(parameter, this.parameterStyles); }
      ...
      public Ansi.Text optionParamText(String optionParam) { return this.ansi().apply(optionParam, this.optionParamStyles); }
      ...
      private void replace(List<IStyle> styles, String property) {
        if (property != null) {
          styles.clear();
          this.addAll(styles, Style.parse(property));
        }
      }
      ...
      public Ansi ansi() { return this.ansi; }
    }
    ...
    public enum Ansi {
      ...
      public enum Style implements IStyle {
        ...
        public String on() { return CSI + this.startCode + "m"; }
        public String off() { return CSI + this.endCode + "m"; }
      ...
      static class Palette256Color implements IStyle {
        ...
        public String on() { return String.format(CSI + "%d;5;%dm", this.fgbg, this.color); }
        public String off() { return CSI + (this.fgbg + 1) + "m"; }
      }
      ...
      public class Text implements Cloneable {
        ...
        public Text(String input) {
          ...
          while (true) {
            ...
            this.addStyledSection(this.plain.length(), items[1].length(),
        ...
        public Text[] splitLines() {
          ...
          int start = 0, end = 0;
          for (int i = 0; i < this.plain.length(); i++, end = i) {
        ...
        @Deprecated public Text append(String string) { return this.concat(string); }
        /** @deprecated use {@link #concat(Text)} instead */
        @Deprecated public Text append(Text text) { return this.concat(text); }
         ...
         * @since 3.0 */
        public Text concat(String string) { return this.concat(new Text(string)); }
        ...
        public String plainString() {  return this.plain.toString().substring(this.from, this.from + this.length); }

        public boolean equals(Object obj) { return this.toString().equals(String.valueOf(obj)); }
  ...
  private enum TraceLevel { OFF, WARN, INFO, DEBUG;
    public boolean isEnabled(TraceLevel other) { return this.ordinal() >= other.ordinal(); }
    private void print(Tracer tracer, String msg, Object... params) {
      if (tracer.level.isEnabled(this)) { tracer.stream.printf(this.prefix(msg), params); }
    }
  ...
  private static class Tracer {
    ...
    boolean isWarn()  { return this.level.isEnabled(TraceLevel.WARN); }
    boolean isInfo()  { return this.level.isEnabled(TraceLevel.INFO); }
    boolean isDebug() { return this.level.isEnabled(TraceLevel.DEBUG); }
  }
  /**
  ...
  public static class ParameterException extends PicocliException {
     ...
     * @since 3.2
     */
    public ArgSpec getArgSpec() { return this.argSpec; }
  ...
  public static class MissingParameterException extends ParameterException {
    ...
    public List<ArgSpec> getMissing() { return this.missing; }
  ...
  public static class UnmatchedArgumentException extends ParameterException {
     ...
     * @since 3.3.0 */
    public List<String> getUnmatched() { return Collections.unmodifiableList(this.unmatched); }
    /** Returns {@code true} if the first unmatched command line arguments resembles an option, {@code false} otherwise.
     * @since 3.3.0 */
    public boolean isUnknownOption() { return isUnknownOption(this.unmatched, this.getCommandLine()); }
    /** Returns {@code true} and prints suggested solutions to the specified stream if such solutions exist, otherwise returns {@code false}.
     * @since 3.3.0 */
    public boolean printSuggestions(PrintStream out) {
      List<String> suggestions = this.getSuggestions();
      if (!suggestions.isEmpty()) {
        out.println(this.isUnknownOption()
    ...
    public List<String> getSuggestions() {
      if (this.unmatched == null || this.unmatched.isEmpty()) { return Collections.emptyList(); }
      String arg = this.unmatched.get(0);
      String stripped = CommandSpec.stripPrefix(arg);
      CommandSpec spec = this.getCommandLine().getCommandSpec();
  ...
  public static class OverwrittenOptionException extends ParameterException {
     ...
     * @since 3.8 */
    public ArgSpec getOverwritten() { return this.overwrittenArg; }
  }
  /**
