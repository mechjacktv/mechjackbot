...
import tv.mechjack.platform.webapp.services.dispatch.UnsupportedMediaTypeException;

public final class PojoArgumentHandler implements ArgumentHandler {
  ...
  @Inject
  public PojoArgumentHandler(final Gson gson) {
    this.gson = gson;
  }
